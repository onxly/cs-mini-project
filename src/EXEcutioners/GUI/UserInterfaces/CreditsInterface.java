...
public class CreditsInterface extends BorderPane implements IPreviousHelper {
	...
	private void isClicked()
	{
		BackButton.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent arg0) {
				...
				WindowHandler.HandleSwitch(Container,CreditsInterface.this, PreviousView, "right");
